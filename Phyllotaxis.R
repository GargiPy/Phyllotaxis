...
# Change the above code to modify the 
...
# Copy the above code and modify the 
...
# Copy the above code and modify the color and
# shape of the points, and the background color
p <- ggplot(df, aes(x*t, y*t))
p +  theme(panel.background = element_rect(fill = "darkmagenta"),
           legend.position = "none",
           panel.grid = element_blank(),
           axis.ticks = element_blank(),
           axis.title = element_blank(),
